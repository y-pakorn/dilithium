...
export function keypair_derive(a: number, b: number): number;
export function keys_pubkey(a: number, b: number): void;
export function keys_secret(a: number, b: number): void;
export function keys_sign_bytes(a: number, b: number, c: number, d: number, e: number): void;
export function keys_sign_json(a: number, b: number, c: number, d: number, e: number): void;
export function keys_pk_json(a: number, b: number): void;
export function keys_expanded_pk_json(a: number, b: number): void;
...
export function keys_derive(a: number, b: number): number;
